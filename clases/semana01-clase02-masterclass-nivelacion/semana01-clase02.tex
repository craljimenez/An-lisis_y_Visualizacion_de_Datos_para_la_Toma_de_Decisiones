% ============================================================
%  Semana 1 · Clase 2 — MasterClass (Nivelación)
%  Curso: Análisis y Visualización de Datos para la Toma de Decisiones
%
%  Nota de numeración: en el Excel oficial esta sesión es "Semana 2"
%  (comparte semana con "Fundamentos de estadística descriptiva"). Para
%  la agenda real del docente, la Semana 1 de Encuentro Inicial y esta
%  semana del Excel se agrupan como una sola "Semana 1" — el número de
%  Semana baja en 1 desde aquí en adelante, pero el número de Clase
%  (secuencial en todo el curso) NO cambia.
%
...
\begin{frame}{Cierre}
  \begin{itemize}
    \item Próxima sesión: \textbf{Fundamentos de estadística descriptiva} (Semana 1 · Clase 3, virtual).
