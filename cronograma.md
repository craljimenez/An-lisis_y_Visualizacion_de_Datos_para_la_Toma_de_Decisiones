...
|---|---|---|---|---|---|
| 1 | Sep 1 al 7 | 1 | Encuentro Inicial (incluye panorama del ecosistema de datos) | Híbrido | 3 |
| 1 | Sep 8 al 13 | 2 | Fundamentos de estadística descriptiva | Virtual | 3 |
| 2 | Sep 15 al 20 | 3 | Python para análisis de datos: fundamentos | Virtual | 3 |
| 2 | Sep 15 al 20 | 4 | Python aplicado a datos y preparación para SQL | Virtual | 3 |
| 3 | Sep 22 al 27 | 5 | Bases de datos relacionales y SQL básico | Virtual | 3 |
| 3 | Sep 22 al 27 | 6 | MasterClass (Recapitulación) | Presencial | 3 |
| 4 | Sep 29 al 4 Oct | 7 | Pandas: DataFrames y diagnóstico de calidad | Virtual | 3 |
| 4 | Sep 29 al 4 Oct | 8 | Transformación y enriquecimiento de datos | Virtual | 3 |
| 5 | Oct 6 al 11 | 9 | Agrupaciones y análisis con groupby | Virtual | 3 |
| 5 | Oct 6 al 11 | 10 | Merge, concatenación e integración de fuentes | Virtual | 3 |
...
| 9 | Nov 3 al 8 | 18 | MasterClass (Recapitulación y prep. bootcamp) | Presencial | 3 |
| 10 | Nov 10 al 15 | 19 | De la analítica descriptiva a la predictiva | Virtual | 3 |
| 10 | Nov 10 al 15 | 20 | Regresión lineal con Python | Virtual | 3 |
| 11 | Nov 17 al 22 | 21 | Storytelling con datos: del hallazgo a la decisión | Virtual | 3 |
| 11 | Nov 17 al 22 | 22 | Diseño del argumento ejecutivo y métricas de impacto | Virtual | 3 |
