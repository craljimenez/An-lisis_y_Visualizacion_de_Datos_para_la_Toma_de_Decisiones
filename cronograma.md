...
**Periodo:** 20262 · Sep 1 – Dic 13 · **14 semanas (agenda del docente) · 89 horas totales**.

> ℹ️ **Numeración ajustada a la agenda real del docente.** El Excel oficial
> de Esumer tiene 15 semanas; el docente no puede asistir a la MasterClass
> presencial en su fecha original de "Semana 2", así que esa sesión se
> agrupó junto con la Semana 1 (que pasa a tener 3 clases: Encuentro
> Inicial, MasterClass y Fundamentos de estadística descriptiva). De ahí en
> adelante, cada **Semana** de este documento es la del Excel oficial menos
> 1 — el número de **Clase** (secuencial, 1 a 28) no cambia y sigue
> exactamente el orden del Excel.
...
| 3. Experimentar | 8–9 | Business Intelligence con Power BI | Power BI Desktop |
| 4. Innovar | 10–13 | Analítica predictiva y storytelling | Scikit-Learn, Canva/Slides |
| 5. Transformar | 14 | Cierre: dashboard empresarial aplicado | Power BI, Python, GitHub (opcional) |
...
| 1 | Sep 8 al 13 | 2 | MasterClass (Nivelación): panorama del ecosistema de datos | Presencial | 3 |
| 1 | Sep 8 al 13 | 3 | Fundamentos de estadística descriptiva | Virtual | 3 |
| 2 | Sep 15 al 20 | 4 | Python para análisis de datos: fundamentos | Virtual | 3 |
| 2 | Sep 15 al 20 | 5 | Python aplicado a datos y preparación para SQL | Virtual | 3 |
| 3 | Sep 22 al 27 | 6 | Bases de datos relacionales y SQL básico | Virtual | 3 |
| 3 | Sep 22 al 27 | 7 | MasterClass (Recapitulación) | Presencial | 3 |
| 4 | Sep 29 al 4 Oct | 8 | Pandas: DataFrames y diagnóstico de calidad | Virtual | 3 |
| 4 | Sep 29 al 4 Oct | 9 | Transformación y enriquecimiento de datos | Virtual | 3 |
| 5 | Oct 6 al 11 | 10 | Agrupaciones y análisis con groupby | Virtual | 3 |
| 5 | Oct 6 al 11 | 11 | Merge, concatenación e integración de fuentes | Virtual | 3 |
| 6 | Oct 13 al 18 | 12 | Principios de visualización y comunicación de datos | Virtual | 3 |
| 6 | Oct 13 al 18 | 13 | MasterClass (Recapitulación y prep. bootcamp) | Presencial | 3 |
| 7 | Oct 20 al 25 | 14 | Bootcamp | Presencial | 3 |
| 7 | Oct 20 al 25 | 15 | Bootcamp (bloque 2, ⚠️ sin tema en el Excel) | Presencial | 3 |
| 8 | Oct 27 al 1 Nov | 16 | Power BI: carga, transformación y modelo de datos | Virtual | 3 |
| 8 | Oct 27 al 1 Nov | 17 | Dashboard e identificación de insights | Virtual | 3 |
| 9 | Nov 3 al 8 | 18 | Identificación de insights (cont.) | Virtual | 3 |
| 9 | Nov 3 al 8 | 19 | MasterClass (Recapitulación y prep. bootcamp) | Presencial | 3 |
| 10 | Nov 10 al 15 | 20 | De la analítica descriptiva a la predictiva | Virtual | 3 |
| 10 | Nov 10 al 15 | 21 | Regresión lineal con Python | Virtual | 3 |
| 11 | Nov 17 al 22 | 22 | Storytelling con datos: del hallazgo a la decisión | Virtual | 3 |
| 11 | Nov 17 al 22 | 23 | Diseño del argumento ejecutivo y métricas de impacto | Virtual | 3 |
| 12 | Nov 24 al 29 | 24 | Clínica de analítica predictiva y storytelling | Virtual | 3 |
| 12 | Nov 24 al 29 | 25 | MasterClass (Recapitulación y prep. bootcamp) | Presencial | 3 |
| 13 | Dic 1 al 6 Dic | 26 | Bootcamp | Presencial | 3 |
| 13 | Dic 1 al 6 Dic | 27 | Bootcamp (bloque 2, ⚠️ sin tema en el Excel) | Presencial | 3 |
| 14 | Dic 7 al 13 | 28 | Semana de la Innovación Multidisciplinar (cierre) | Presencial | 8 |
...
- **Clase 1 — Encuentro Inicial (Refrigerio)** · Híbrido · 3 h · Sep 1 al 7
- **Clase 2 — MasterClass (Nivelación): Encuentro inicial y panorama del desarrollo web** · Presencial · 3 h · Sep 8 al 13
...
- **Clase 3 — Fundamentos de estadística descriptiva** · Virtual · 3 h · Sep 8 al 13
...
1. **Numeración de semanas ajustada.** El Excel oficial de Esumer tiene 15 semanas; este documento tiene 14 porque agrupa la Semana 1 y la antigua Semana 2 del Excel en una sola "Semana 1" (el docente no puede dar la MasterClass presencial en su fecha original, así que esa sesión y "Fundamentos de estadística descriptiva" quedan junto con el Encuentro Inicial). El número de **Clase** (1 a 28) es el mismo que en el Excel y no se ve afectado por este ajuste.
2. **Filas ocultas del Excel — ignoradas.** La hoja "Analítica" tiene 5 filas ocultas (20, 31, 36, 49, 50). Todas están vacías salvo la 36, que traía un tema ajeno al curso ("Automatización de procesos: eventos, triggers y actions", de otra hoja del mismo libro). Como está oculta en el Excel — no aparece al abrir/mirar la hoja —, se excluyó del cronograma.
3. **Semanas 7 y 13 (Bootcamp):** cada semana de bootcamp trae dos bloques de 3 h en el Excel, pero el segundo bloque no tiene tema propio (fila casi vacía, solo con las horas, y esta sí es visible en la hoja). Probablemente ambos bloques comparten el mismo contenido de bootcamp (trabajo autónomo/asesoría sobre el proyecto integrador) — vale la pena confirmarlo para no dejar la sesión "en blanco" en la planeación de clase.
4. El total de horas (89) cuadra con la suma fila por fila del Excel, contando las filas visibles únicamente — el ajuste de numeración de semanas no cambia horas ni contenidos, solo cómo se agrupan.
